...
#pyuic4 rodpendulum.ui -o rodpendulum.py
...
#pyuic4 template_xc.ui -o template_xc.py
...
#pyuic4 calibration_loader.ui -o calibration_loader.py
#pyuic4 dsm501.ui -o dsm501.py
