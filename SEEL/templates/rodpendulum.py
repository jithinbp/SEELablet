...
"}"))
        ...
        self.frame_5 = QtGui.QFrame(self.widgetFrameOuter)
        ...
        self.pushButton_5.setMinimumSize(QtCore.QSize(94, 30))
        self.pushButton_5.setMaximumSize(QtCore.QSize(300, 16777215))
        self.pushButton_5.setObjectName(_fromUtf8("pushButton_5"))
        self.horizontalLayout_3.addWidget(self.pushButton_5)
        self.timerProgress = QtGui.QProgressBar(self.frame_5)
        ...
        self.horizontalLayout_3.addWidget(self.timerProgress)
        ...
        self.gridLayout_2.addWidget(self.averageLabel, 2, 1, 1, 1)
        self.averageLabel_2 = QtGui.QLabel(self.frame_3)
        self.averageLabel_2.setObjectName(_fromUtf8("averageLabel_2"))
        self.gridLayout_2.addWidget(self.averageLabel_2, 7, 0, 1, 1)
        ...
        self.diaBox = QtGui.QSpinBox(self.frame_3)
        self.diaBox.setEnabled(False)
        self.diaBox.setObjectName(_fromUtf8("diaBox"))
        self.gridLayout_2.addWidget(self.diaBox, 10, 1, 1, 1)
        ...
        QtCore.QObject.connect(self.pushButton_5, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.downloadData)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Start Timer", None))
        self.pushButton_3.setText(_translate("MainWindow", "Stop Timer", None))
        self.progressBar.setFormat(_translate("MainWindow", "%v", None))
        self.pushButton_5.setText(_translate("MainWindow", "Load Data points into spreadsheet", None))
...
" Oscillations must finish within this time limit", None))
        self.timerProgress.setFormat(_translate("MainWindow", "%v Seconds to timer overflow", None))
...
"Hold down CTRL key and click to select non consecutive points", None))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Average", None))
        self.label.setText(_translate("MainWindow", "Data Analysis", None))
        self.label_3.setText(_translate("MainWindow", "Diameter", None))
